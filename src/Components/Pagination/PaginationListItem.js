...
const PaginatorListItem = styled.li.attrs(({ className = 'paginator-list-item' }) => ({ className }))`
  ...
  background-color: ${({ secondary, theme, active }) => (!secondary && active ? theme.BACKGROUND_THEME : 'inherit')};
  > button {
