...
export const Colors = {
  ...
  CHART_PIE_YES: allColors.GREEN_POSITIVE_PRIMARY,
  CHART_PIE_NOWITHVETO: allColors.RED_NEGATIVE_PRIMARY,
  CHART_PIE_NO: allColors.BLUE_LIGHTEST,
  CHART_PIE_ABSTAIN: allColors.GRAY_PRIMARY,
  CHART_PIE_CIRCULATION: allColors.GREEN_DARK,
  CHART_PIE_COMMUNITY: allColors.YELLOW_LIGHT,
  CHART_PIE_BURNED: allColors.RED_DARKER,
  CHART_PIE_BONDED: allColors.TEAL_LIGHT,
  CHART_PIE_REMAINING: allColors.PURPLE_DARK,
