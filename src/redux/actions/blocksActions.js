...
import { BLOCK_INFO_URL, BLOCKS_RECENT_URL, BLOCK_SPOTLIGHT_URL, BLOCK_HEIGHT_URL } from 'consts';
...
// API Calls
export const getBlocksHeight = () => async (dispatch) => ajaxGet(GET_BLOCKS_HEIGHT, dispatch, BLOCK_HEIGHT_URL);
